...
export default function InternClientDetailPage() {
  ...
  const fetchClientData = async () => {
    ...
    // Fetch client where the original lead was created by this intern
    ...
    <DashboardLayout allowedRoles={['intern']}>
      ...
      <div className="p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <button
              onClick={() => router.push('/intern/clients')}
