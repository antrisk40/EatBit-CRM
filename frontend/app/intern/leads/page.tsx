...
// Force dynamic rendering to prevent static pre-rendering issues
...
export default function InternLeadsPage() {
  ...
  const fetchLeads = async () => {
    try {
      ...
      if (userError) {
        console.error('[InternLeads] Error getting user:', userError);
      ...
      // Intern can see leads they created
      ...
      if (error) {
        console.error('[InternLeads] Error fetching leads:', error);
        toast.error('Failed to load leads');
      } else {
        setLeads(data || []);
      }
    } catch (error) {
      console.error('[InternLeads] Unexpected error:', error);
      ...
      <div className="p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your created leads</p>
          </div>
          <button
